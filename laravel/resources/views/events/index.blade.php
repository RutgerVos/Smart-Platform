  ...
  <div style=" background-color: rgba(0, 0, 0, 0.8)" class="fixed z-40 top-0 right-0 left-0 bottom-0 h-full w-full" x-show.transition.opacity="openEventModal">
    <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
      ...
      <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
        ...
        <div class="mb-4">
          <label class="text-gray-800 block mb-1 font-bold text-sm tracking-wide">Event start time</label>
          <input type="time" id="appt" name="time" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500">
        </div>
  ...
  function app() {
    return {
      ...
      events: [
        ...
        {
          event_date: new Date(2021, 10, 11),
